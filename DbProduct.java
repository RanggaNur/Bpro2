 ...
 Scanner sc = new Scanner (System.in);
  boolean Selesai = false;
	  do{
	   System.out.println ("");
	   System.out.println ("==========================");
	   System.out.println (" PENCARIAN DATA PRODUCT ");
	   System.out.println ("==========================");
	   System.out.println ("");
	   System.out.println ("1. Pencarian data product per kode");
	   ...
	   int piluser = sc.nextInt();
		   ...
		   if (piluser == 1)
			{
			  System.out.print("Input Kode Product : ");
			  String kd=br.readLine();

			  for(int k =0;k<tblHerbal.length;k++){
				if(tblHerbal[k][0].equals(kd)){
					System.out.println();
			 ...
			 if (piluser == 4)
			{
			  ...
			  String hrg=br.readLine();

			  for(int k =0;k<tblHerbal.length;k++){
				if(tblHerbal[k][3].contains(hrg)){
					System.out.println();
				  System.out.println(tblHerbal[k][0]+" "+ tblHerbal[k][1]+" "+ tblHerbal[k][2]+" "+ tblHerbal[k][3]);
				  System.out.println();
					System.out.println("Pada data ke "+k);
